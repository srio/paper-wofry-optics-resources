...
def run_source(my_mode_index=0):
    ...
    output_wavefront.set_gaussian_hermite_mode(sigma_x=3.05717e-05, amplitude=1, mode_x=0, shift=0, beta=0.110865)
    # previous command is useless but...
    output_wavefront.set_gaussian_hermite_mode(sigma_x=3.05717e-05, amplitude=1, mode_x=my_mode_index, shift=0,
                                               beta=0.110865)
